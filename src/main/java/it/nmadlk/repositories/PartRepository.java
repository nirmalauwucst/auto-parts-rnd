 ...
 * Spring Data JPA comes with one common repositories called "CrudRepository<>". This is an interface and you just have to extend this.
 * Your custom repositories is extended by "CrudRepository<>" which contains all the common methods/CRUD operations.
